output "ec2_public_instance_ids" {
  ...
  value       = "The id of the instance is ${aws_instance.first-ec2.id}"
}
output "ec2_public_ip" {
  description = "Public ip address assigned to the instances"
  value       = "The public ip of the instance is ${aws_instance.first-ec2.public_ip}"
}
...
output "ec2_private_ip" {
  ...
  value       = "The private ip of the instance is ${aws_instance.ec2-private.private_ip}"
}
